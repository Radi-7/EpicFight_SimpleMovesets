...
public class WeaponCategoryMapper {
    private static final Map<ModWeaponCategories, WeaponCategory> categoryMap = new HashMap<>();

    static {
        categoryMap.put(ModWeaponCategories.SABER, CapabilityItem.WeaponCategories.SWORD);
    }

    public static CapabilityItem.Builder apply(Item item, ModWeaponCategories category) {
